...
export default function BirdResidenceHybrid() {
  ...
  return (
    <main>
      ...
      {/* ── Full-bleed hero — first thing you see ── */}
      ...
      {/* ── Original layout below — exactly as the current [slug] page ── */}
